...
BOTPRESS_URL = os.environ.get("BOTPRESS_URL")  # Example: https://api.botpress.cloud/v1/bot/<bot-id>/mod/channel-webhook/incoming
...
def webhook():
    ...
    # Corrected payload format for Botpress webhook
    bot_request = {
        "type": "text",
        "payload": {
            "text": user_text
